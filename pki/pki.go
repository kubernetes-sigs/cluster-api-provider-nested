...
import (
	...
	pkiutil "sigs.k8s.io/cluster-api-provider-nested/pki/util"
...
func NewAPIServerCrtAndKey(ca *CrtKeyPair, ncp *v1alpha3.NestedControlPlane, apiserverDomain string, apiserverIPs ...string) (*CrtKeyPair, error) {
	clusterDomain := defaultClusterDomain
	if ncp.Spec.ClusterDomain != "" {
		clusterDomain = ncp.Spec.ClusterDomain
	}
	...
	config := &pkiutil.CertConfig{
		Config: cert.Config{
			CommonName: ncp.Status.ClusterNamespace,
			AltNames:   *altNames,
