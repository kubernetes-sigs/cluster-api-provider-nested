...
import (
	...
	e2elog "sigs.k8s.io/cluster-api-provider-nested/virtualcluster/test/e2e/framework/log"
	e2epod "sigs.k8s.io/cluster-api-provider-nested/virtualcluster/test/e2e/framework/pod"
	e2evc "sigs.k8s.io/cluster-api-provider-nested/virtualcluster/test/e2e/framework/virtualcluster"
)
