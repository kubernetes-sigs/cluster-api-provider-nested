...
import (
	...
	clusterv1alpha4 "sigs.k8s.io/cluster-api-provider-nested/virtualcluster/experiment/pkg/apis/cluster/v1alpha4"
	versioned "sigs.k8s.io/cluster-api-provider-nested/virtualcluster/experiment/pkg/client/clientset/versioned"
	internalinterfaces "sigs.k8s.io/cluster-api-provider-nested/virtualcluster/experiment/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha4 "sigs.k8s.io/cluster-api-provider-nested/virtualcluster/experiment/pkg/client/listers/cluster/v1alpha4"
)
