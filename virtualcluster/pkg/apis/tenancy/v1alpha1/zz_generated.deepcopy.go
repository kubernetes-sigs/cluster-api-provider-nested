...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (vc *VirtualCluster) DeepCopyInto(out *VirtualCluster) {
	*out = *vc
	out.TypeMeta = vc.TypeMeta
	vc.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	vc.Spec.DeepCopyInto(&out.Spec)
	vc.Status.DeepCopyInto(&out.Status)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtualCluster.
func (vc *VirtualCluster) DeepCopy() *VirtualCluster {
	if vc == nil {
		return nil
	}
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (vc *VirtualCluster) DeepCopyObject() runtime.Object {
	if c := vc.DeepCopy(); c != nil {
		return c
	}
	return nil
}
